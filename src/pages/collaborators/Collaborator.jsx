...
const Collaborator = () => {
  ...
  return (
    <section ref={collaboratoresRef} className='collaborator__container'>
      ...
      <section className='collaborator'>
        <aside className='collaborator__about-container'>
          ...
          <p>
            ...
            comunidades afectadas por la DANA. Conectando voluntarios con
            familias y personas damnificadas en su camino hacia la recuperación.
          </p>
        </aside>
          ...
          {collaborators.map((collaborator, index) => (
            <article key={index} className='collaborator__card'>
              <div className='collaborator__social'>
                <a
                  className='collaborator__social-link'
                  href={collaborator.urlLinkedin}
                  target='_blank'
